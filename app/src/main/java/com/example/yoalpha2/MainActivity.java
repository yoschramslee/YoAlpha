...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            switchView(R.id.content_home);
            // Handle the camera action
        } else if (id == R.id.nav_announcements) {
            View contentMain = findViewById(R.id.content_home);
            if(contentMain instanceof View){
                ((ViewGroup) findViewById(R.id.content_home).getParent()).removeViewAt(1);
            }
        } else if (id == R.id.nav_info) {
            switchView(R.id.content_info);
        } else if (id == R.id.nav_clubsport) {
            switchView(R.id.content_club_sport);
        } else if (id == R.id.nav_teachers) {
            switchView(R.id.content_directory);
        }
